    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-background">
            <div className="mx-auto w-full max-w-lg bg-white rounded-xl p-10 shadow-md border border-gray-200">
                ...
                <h2 className="text-center text-2xl font-bold leading-tight text-textPrimary">Sign up to create account</h2>
                <p className="mt-2 text-center text-base text-textSecondary">
